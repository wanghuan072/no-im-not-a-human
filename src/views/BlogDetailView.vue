        ...
        <div v-else-if="error" class="error-section">
            <div class="container">
                <div class="error-state">
                    ...
                    <a href="/blog" class="btn btn-primary">{{ $t('BlogPage.detail.error.backToBlog') }}</a>
                </div>
            </div>
        </div>
                ...
                <div class="container">
                    <div class="hero-wrapper">
                        ...
                        <nav class="breadcrumb">
                            <a href="/">{{ $t('BlogPage.detail.breadcrumb.home') }}</a>
                            <span class="separator">/</span>
                            <a href="/blog">{{ $t('BlogPage.detail.breadcrumb.blog') }}</a>
                            <span class="separator">/</span>
...
export default {
    ...
    setup() {
        ...
        // 获取博客地址栏路径
        const getBlogAddressBar = () => {
            const path = route.path
            // 移除语言前缀
            const cleanPath = currentLanguage.value === 'en' ? path : path.replace(`/${currentLanguage.value}`, '')
            // 从 /blog/xxx 中提取 xxx 部分
        ...
        const loadBlog = async () => {
            try {
                ...
                const addressBar = getBlogAddressBar()
                const blogData = await getBlogByAddressBar(addressBar, currentLanguage.value)
        ...
        const setupSEO = async (blogData) => {
            ...
            setSEO(seoData, route.path, 'blog-detail')
        }

      ...
      <div class="container">
        <div class="content-wrapper">
          ...
          <p
            ...
            v-html="$t('DownloadPage.requirements.description', {}, { raw: true })"
          ></p>
          ...
          <div class="requirements-grid">
              ...
              <div class="requirement-list">
                <div class="requirement-item">
                  <span class="requirement-label">{{
                    $t('DownloadPage.requirements.labels.os')
                  }}</span>
                  <span class="requirement-value">{{
                    $t('DownloadPage.requirements.minimum.os')
                  }}</span>
                </div>
                <div class="requirement-item">
                  <span class="requirement-label">{{
                    $t('DownloadPage.requirements.labels.processor')
                  }}</span>
                  <span class="requirement-value">{{
                    $t('DownloadPage.requirements.minimum.processor')
                  }}</span>
                </div>
                <div class="requirement-item">
                  <span class="requirement-label">{{
                    $t('DownloadPage.requirements.labels.memory')
                  }}</span>
                  <span class="requirement-value">{{
                    $t('DownloadPage.requirements.minimum.memory')
                  }}</span>
                </div>
                <div class="requirement-item">
                  <span class="requirement-label">{{
                    $t('DownloadPage.requirements.labels.graphics')
                  }}</span>
                  <span class="requirement-value">{{
                    $t('DownloadPage.requirements.minimum.graphics')
                  }}</span>
                </div>
                <div class="requirement-item">
                  <span class="requirement-label">{{
                    $t('DownloadPage.requirements.labels.directx')
                  }}</span>
                  <span class="requirement-value">{{
                    $t('DownloadPage.requirements.minimum.directx')
                  }}</span>
                </div>
                <div class="requirement-item">
                  <span class="requirement-label">{{
                    $t('DownloadPage.requirements.labels.storage')
                  }}</span>
                  <span class="requirement-value">{{
                    $t('DownloadPage.requirements.minimum.storage')
                  }}</span>
                </div>
                <div class="requirement-item">
                  <span class="requirement-label">{{
                    $t('DownloadPage.requirements.labels.sound')
                  }}</span>
                  <span class="requirement-value">{{
                    $t('DownloadPage.requirements.minimum.sound')
                  }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="requirement-card recommended">
              <h3 class="requirement-title">
                {{ $t('DownloadPage.requirements.recommended.title') }}
              </h3>
              <div class="requirement-list">
                <div class="requirement-item">
                  <span class="requirement-label">{{
                  ...
                  <span class="requirement-value">{{
                    $t('DownloadPage.requirements.recommended.os')
                  }}</span>
                </div>
                <div class="requirement-item">
                  <span class="requirement-label">{{
                  ...
                  <span class="requirement-value">{{
                    $t('DownloadPage.requirements.recommended.processor')
                  }}</span>
                </div>
                <div class="requirement-item">
                  <span class="requirement-label">{{
                  ...
                  <span class="requirement-value">{{
                    $t('DownloadPage.requirements.recommended.memory')
                  }}</span>
                </div>
                <div class="requirement-item">
                  <span class="requirement-label">{{
                  ...
                  <span class="requirement-value">{{
                    $t('DownloadPage.requirements.recommended.graphics')
                  }}</span>
                </div>
                <div class="requirement-item">
                  <span class="requirement-label">{{
                  ...
                  <span class="requirement-value">{{
                    $t('DownloadPage.requirements.recommended.directx')
                  }}</span>
                </div>
                <div class="requirement-item">
                  <span class="requirement-label">{{
                  ...
                  <span class="requirement-value">{{
                    $t('DownloadPage.requirements.recommended.storage')
                  }}</span>
                </div>
                <div class="requirement-item">
                  <span class="requirement-label">{{
                  ...
                  <span class="requirement-value">{{
                    $t('DownloadPage.requirements.recommended.sound')
                  }}</span>
                </div>
              </div>
            </div>
          ...
          <div class="platform-grid">
            <div class="platform-card windows">
              ...
              <p
                ...
                v-html="$t('DownloadPage.compatibility.windows.description', {}, { raw: true })"
              ></p>
              <div class="platform-details">
                <div class="detail-item">
                  <span class="detail-label">{{
                    $t('DownloadPage.compatibility.labels.supported')
                  }}</span>
                  <span class="detail-value">{{
                    $t('DownloadPage.compatibility.windows.supported')
                  }}</span>
                </div>
                <div class="detail-item">
                  <span class="detail-label">{{
                    $t('DownloadPage.compatibility.labels.recommended')
                  }}</span>
                  <span class="detail-value">{{
                    $t('DownloadPage.compatibility.windows.recommended')
                  }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="platform-card linux">
              ...
              <p
                class="platform-description"
                v-html="$t('DownloadPage.compatibility.linux.description', {}, { raw: true })"
              ></p>
              <div class="platform-details">
                <div class="detail-item">
                  <span class="detail-label">{{
                    $t('DownloadPage.compatibility.labels.proton')
                  }}</span>
                  <span class="detail-value">{{
                    $t('DownloadPage.compatibility.linux.proton')
                  }}</span>
                </div>
                <div class="detail-item">
                  <span class="detail-label">{{
                    $t('DownloadPage.compatibility.labels.distributions')
                  }}</span>
                  <span class="detail-value">{{
                    $t('DownloadPage.compatibility.linux.distributions')
                  }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="platform-card steam-deck">
              ...
              <p
                class="platform-description"
                v-html="$t('DownloadPage.compatibility.steamDeck.description', {}, { raw: true })"
              ></p>
              <div class="platform-details">
                <div class="detail-item">
                  <span class="detail-label">{{
                    $t('DownloadPage.compatibility.labels.status')
                  }}</span>
                  <span class="detail-value">{{
                    $t('DownloadPage.compatibility.steamDeck.status')
                  }}</span>
                </div>
                <div class="detail-item">
                  <span class="detail-label">{{
                    $t('DownloadPage.compatibility.labels.controls')
                  }}</span>
                  <span class="detail-value">{{
                    $t('DownloadPage.compatibility.steamDeck.controls')
                  }}</span>
                </div>
              </div>
            </div>
    ...
    <section class="section languages">
      <div class="container">
        <div class="content-wrapper">
          ...
          <p
            class="section-description"
            v-html="$t('DownloadPage.languages.description', {}, { raw: true })"
          ></p>
    ...
    <section class="section game-info">
      <div class="container">
        <div class="content-wrapper">
          ...
          <p
            class="section-description"
            v-html="$t('DownloadPage.gameInfo.description', {}, { raw: true })"
          ></p>
          ...
          <div class="info-card">
            ...
            <div class="info-list">
              ...
              <div class="info-item">
                ...
                <span
                  class="info-value"
                  v-html="$t('DownloadPage.gameInfo.basicInfo.developer', {}, { raw: true })"
                ></span>
              </div>
              <div class="info-item">
                <span class="info-label">{{ $t('DownloadPage.gameInfo.labels.publisher') }}</span>
                <span class="info-value">{{
                  $t('DownloadPage.gameInfo.basicInfo.publisher')
                }}</span>
              </div>
              <div class="info-item">
              ...
              <div class="info-item">
                ...
                <span
                  class="info-value"
                  v-html="$t('DownloadPage.gameInfo.basicInfo.releaseDate', {}, { raw: true })"
                ></span>
              </div>
            </div>
            ...
            <div class="download-section">
              ...
              <p
                ...
                v-html="$t('DownloadPage.gameInfo.download.description', {}, { raw: true })"
              ></p>
              <a
                href="https://store.steampowered.com/app/3180070/_/"
                target="_blank"
                rel="noopener noreferrer nofollow"
                class="download-btn steam"
              >
